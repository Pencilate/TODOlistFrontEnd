                ...
                return (
                    <div className={classes.paper}>
                        <div className={classes.modalContent}> 
                            <TextField type="text" id="modaltitle" name="title" label="Title" variant="outlined" value={this.state.currentTodo.title} InputProps={{readOnly: true,}} onChange={this.handleChange} fullWidth/>
                            {chip}
                            <TextField type="text" id="modaldescription" name="description" label="Description" variant="outlined" value={this.state.currentTodo.title} InputProps={{readOnly: true,}} onChange={this.handleChange} fullWidth rowsMax="10" multiline/>    
                        </div>
                        <div className={classes.modalButton}>
                            <Button variant="contained" id="btnModalEdit" startIcon={<AddTwoToneIcon/>}>Edit</Button>
                        </div>
                    </div>
